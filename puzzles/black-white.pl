...
arc([blank, A, B, C, D, E, F], Child, 1) :-
    Child is [A, blank, B, C, D, E, F].

arc([blank, A, B, C, D, E, F], Child, 1) :-
    Child is [B, A, blank, C, D, E, F].

arc([blank, A, B, C, D, E, F], Child, 2) :-
    Child is [C, A, B, blank, D, E, F].

/* [A, blank, B, C, D, E, F] */

arc([A, blank, B, C, D, E, F], Child, 1) :-
    Child is [blank, A, B, C, D, E, F].

arc([A, blank, B, C, D, E, F], Child, 1) :-
    Child is [A, B, blank, C, D, E, F].

arc([A, blank, B, C, D, E, F], Child, 1) :-
    Child is [A, C, B, blank, D, E, F].

arc([A, blank, B, C, D, E, F], Child, 2) :-
    Child is [A, D, B, C, blank, E, F].
...
arc([A, B, blank, C, D, E, F], Child, 1) :-
    Child is [A, B, C, blank, D, E, F].

arc([A, B, blank, C, D, E, F], Child, 1) :-
    Child is [blank, B, A, C, D, E, F].

arc([A, B, blank, C, D, E, F], Child, 1) :-
    Child is [A, B, D, C, blank, E, F].

arc([A, B, blank, C, D, E, F], Child, 1) :-
    Child is [A, B, E, C, D, blank, F].
...
arc([A, B, C, blank, D, E, F], Child, 1) :-
    Child is [A, B, C, D, blank, E, F].

arc([A, B, C, blank, D, E, F], Child, 1) :-
    Child is [A, blank, C, B, D, E, F].

arc([A, B, C, blank, D, E, F], Child, 1) :-
    Child is [A, B, C, E, D, blank, F].

arc([A, B, C, blank, D, E, F], Child, 2) :-
    Child is [blank, B, C, A, D, E, F].

arc([A, B, C, blank, D, E, F], Child, 2) :-
    Child is [A, B, C, F, D, E, blank].
...
arc([A, B, C, D, blank, E, F], Child, 1) :-
    Child is [A, B, C, D, E, blank, F].

arc([A, B, C, D, blank, E, F], Child, 1) :-
    Child is [A, B, blank, D, C, E, F].

arc([A, B, C, D, blank, E, F], Child, 1) :-
    Child is [A, B, C, D, F, E, blank].

arc([A, B, C, D, blank, E, F], Child, 2) :-
    Child is [A, blank, C, D, B, E, F].
...
arc([A, B, C, D, E, blank, F], Child, 1) :-
    Child is [A, B, C, D, E, F, blank].

arc([A, B, C, D, E, blank, F], Child, 1) :-
    Child is [A, B, C, blank, E, D, F].

arc([A, B, C, D, E, blank, F], Child, 2) :-
    Child is [A, B, blank, D, E, C, F].
...
arc([A, B, C, D, E, F, blank], Child, 1) :-
    Child is [A, B, C, D, blank, F, E].

arc([A, B, C, D, E, F, blank], Child, 2) :-
    Child is [A, B, C, blank, E, F, D].
